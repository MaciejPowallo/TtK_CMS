...
if(isset($_POST['submit'])){
	...
	$changed = $settings->undoInvestments($invest_id);

	    if($changed == TRUE){
			$_SESSION['alert'] = '<div class="alert alert-success"><i class="fa fa-check-square-o fa-2x" aria-hidden="true"></i> Inwestycja została przywrócona do sprzedaży</div>';
