...
<head>
	...
	<title>Domy w zabudowie szeregowej w Namysłowie</title>
</head>
<body>
...
<section id="title" class="container">
    <div class="col-xs-12 text-center offset-50 text-red"> <h2 class="title_font">Sprzedane <br><small>Domy parterowe w zabudowie bliźniaczej</small> </h2> </div>
...
<!-- Item modal -->
	<?php include('../forsale/controllers/invest_item.php'); ?>
</body>
</html>
