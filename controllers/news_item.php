                                 ...
                                 foreach ($images as $image) {
                                    echo '
                                       <div  class="col-xs-3 box">
                                          <a data-lightbox="news' . $row['news_id'] . '" href="' . SITE_PATH . 'app/res/images/news/' . $image['image_name'] . '" ><img src="' . SITE_PATH . 'app/res/images/news/' . $image['image_name'] . '" class="image" alt="">
                                          </a>
                                       </div>';
                                 }
   echo '
