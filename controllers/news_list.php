...
//display results
    foreach($stmt as $row)  
    {
		...
		if (strlen($content) > 340) {
		    $contentCut = substr($content, 0, 340);
        ...
        echo '    
				...
				<div class="col-sm-7 col-xs-12">
					<div class="row">
                 	...
                 	<div class="col-xs-12 news-contents">'. $content . '<a href="#news'.  $row['news_id'] .'" data-toggle="modal">Zobacz więcej</a></div>  
                </div>  
		...
		echo '
		            <form action="controllers/add_image.php" class="form-inline switch_off" method="post" enctype="multipart/form-data">
		            	<div class="col-sm-12 col-xs-12 button_margin offset-row ">
		            		<input type="text" class="form-control hidden" value="' . $row['news_id'] .'" id="news_id" name="news_id">
