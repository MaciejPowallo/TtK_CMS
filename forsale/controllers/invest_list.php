    ...
    foreach($stmt as $row)  
    {
        ...
        echo '
                    <div class="invest_image_sold switch_off">
                        <form action="controllers/sale_invest.php" class="form-inline" method="POST">
                            <div class="col-xs-12 button_margin offset-row">
                                ...
                                <button type="submit" name="submit" id="submit" class="btn btn-warning col-xs-12 centered text-center" data-toggle="tooltip" title="Pozwala oznaczyć wpis jako sprzedany"><i class="fa fa-cart-arrow-down fa-2x" aria-hidden="true"></i></button>
                            </div>
                        </form>
                    </div>

                    <div class="invest_image_deleted switch_off">
                        <form action="../forsale/controllers/delete_invest.php" class="form-inline" method="POST">
                            <div class="col-xs-12 button_margin offset-row">
                                <input type="text" class="form-control hidden" value="' . $row['invest_id'] .'" id="invest_id" name="invest_id">
                                <input type="text" class="form-control hidden" value="' . $page_name .'" id="page_name" name="page_name">
		...
		echo '
		            ...
		            <form action="controllers/add_image.php" class="form-inline switch_off" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-12 button_margin offset-row centered text-center">
