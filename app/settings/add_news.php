...
if(isset($_POST['submit'])){
   ...
   else if($size_content  > 5000){
      $CMS->Template->setAlert('<i class="fa fa-exclamation-triangle fa-2x" aria-hidden="true"></i> Zbyt długa treść - maksymalnie 5000 znaków','danger');
      $CMS->Template->load(APP_PATH . 'settings/views/v_news.php');
   }
