...
<div class="container">
		...
		<div class="form-group"><h3>Zmień obrazy w linkach na pierwszej stronie</h3></div>
				...
				<div class="form-group">
			  	...
			  	<div class="form-group col-xs-12">
				  	...
				  	<select class="form-control" name="id_image" id="id_image">
				    	...
				    	<option value="4">Domy parterowe wolnostojące</option>
				    	<option value="5">Domy w zabudowie bliźniaczej</option>
				    	<option value="6">Domy parterowe w zabudowie bliźniaczej</option>
				  	</select>
			  	</div>
