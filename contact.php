...
<body>
   ...
   <!-- Image bg -->
   <section id="bg_nav">
      <img src="<?php echo APP_RES?>/images/main/bg.png" class="bg_image_top_page" alt="">
   </section>
   ...
   <section id="name_block">
      <div class="container">
         <div class="col-sm-5 col-sm-offset-1 name">
            <h3>Company name</h3>
            <h3>111 8th Ave, New York</h3>
         </div>
         <div class="col-sm-5 col-sm-offset-1 name">        
            <h3><i class="fa fa-phone-square" aria-hidden="true"></i> 000 111 222</h3>
            <h3><i class="fa fa-envelope" aria-hidden="true"></i> name&#64;domain.pl</h3>
         </div>
      </div>
   </section>
   ...
   <section  id="map">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.972188718129!2d-74.00422748526361!3d40.74063747932887!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf14f1f51f%3A0xcc1b5ab35bd75df0!2sGoogle!5e0!3m2!1spl!2spl!4v1507589082404" width="900" height="300" frameborder="0" allowfullscreen></iframe>
   </section>
